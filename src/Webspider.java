...
public class Webspider {
        ...
        if(!urls.isEmpty()) {
            ...
            try {
                ...
                for(final URL url : urls) {
                    ...
                    final Elements linksOnPage = document.select("h2[entry-title]");
                    for(final Element element : linksOnPage) {
                        final String urlText = element.attr("h2:entry-title");
    ...
    public static void main(String[] args) throws IOException {
        ...
        final Webspider spider = new Webspider(new URL("https://ikon.mn/"));
